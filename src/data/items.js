...
export const items = [
  ...
  { id: 'plate-20', name: 'Plato 20 cm', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 210, exterior: 133 }, stockOnHand: 343, stockOut: 0, stockBroken: 0, unitCost: 3900, warehouse: 'casa', detail: '' },
  { id: 'plate-bread', name: 'Plato de pan', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 150, exterior: 19 }, stockOnHand: 169, stockOut: 0, stockBroken: 0, unitCost: 3200, warehouse: 'casa', detail: '' },
  { id: 'plate-coffee', name: 'Plato de café', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 150, exterior: 24 }, stockOnHand: 174, stockOut: 0, stockBroken: 0, unitCost: 3200, warehouse: 'casa', detail: '' },
  { id: 'plate-consomme', name: 'Plato consomé', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 56, exterior: 0 }, stockOnHand: 56, stockOut: 0, stockBroken: 0, unitCost: 4800, warehouse: 'casa', detail: '' },
  { id: 'plate-dessert', name: 'Postre cuadrado', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 41, exterior: 0 }, stockOnHand: 41, stockOut: 0, stockBroken: 0, unitCost: 3900, warehouse: 'casa', detail: '' },
  { id: 'plate-dessert-angled', name: 'Postre cuadrado ladeado', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 44, exterior: 0 }, stockOnHand: 44, stockOut: 0, stockBroken: 0, unitCost: 3900, warehouse: 'casa', detail: '' },
  { id: 'dessert-ceramic', name: 'Postre cerámica normal', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 75, exterior: 0 }, stockOnHand: 75, stockOut: 0, stockBroken: 0, unitCost: 3500, warehouse: 'casa', detail: '' },
  { id: 'dessert-ceramic-small', name: 'Postre cerámica chico', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 17, exterior: 0 }, stockOnHand: 17, stockOut: 0, stockBroken: 0, unitCost: 3000, warehouse: 'casa', detail: '' },
  { id: 'dessert-glass', name: 'Postre vidrio', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 25, exterior: 0 }, stockOnHand: 25, stockOut: 0, stockBroken: 0, unitCost: 3500, warehouse: 'casa', detail: '' },
  { id: 'dessert-glass-square', name: 'Postre vidrio cuadrado', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 44, exterior: 0 }, stockOnHand: 44, stockOut: 0, stockBroken: 0, unitCost: 3500, warehouse: 'casa', detail: '' },
  { id: 'dessert-glass-cup', name: 'Postre vidrio copa', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 12, exterior: 0 }, stockOnHand: 12, stockOut: 0, stockBroken: 0, unitCost: 3800, warehouse: 'casa', detail: '' },
  { id: 'brulee-large', name: 'Quembrule grande', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 1, exterior: 0 }, stockOnHand: 1, stockOut: 0, stockBroken: 0, unitCost: 4000, warehouse: 'casa', detail: '' },
  { id: 'brulee-medium', name: 'Quembrule mediano', type: 'asset', category: 'tableware', unit: 'unidad', stock: { casa: 285, exterior: 0 }, stockOnHand: 285, stockOut: 0, stockBroken: 0, unitCost: 3500, warehouse: 'casa', detail: '' },
